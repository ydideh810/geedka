...
const ALL_CAPS = [
  ...
  "chain-pulse","changelog-generate","chromatic-dispersion","citation-formatter","city-lookup",
  ...
  "cron-parser","crypto-fear-greed","crypto-fiat-price","crypto-momentum-pack","crypto-news-impact",
  "crypto-pulse","crypto-top-movers","currency-format","cve-intel","db-perf-intel",
  "defi-market-pulse","defi-portfolio","defi-state-pack","defi-yield-strategies","defi-yields",
  "defillama-coin-price","defillama-pack","defillama-protocol","dex-pair-search","dex-swap-quote",
  "dex-trending-pools","dictionary-intel","dividend-calendar","dividend-intel","dns-lookup",
  "document-qa-prep","domain-availability","domain-whois","drug-intel","earnings-calendar",
  "earnings-surprises","earthquake-intel","economic-calendar","email-verify","energy-brief",
  "ens-lookup","equity-brief","equity-fundamentals","equity-sentiment","equity-technicals",
  "erc20-snapshot","etf-holdings","eth-block","evm-log-events","evm-nonce","evm-token-security",
  "fact-check","fda-recall-watch","fec-donor-intel","federal-contract-intel","federal-register-search",
  "flight-tracker","fomc-tracker","forex-historical","forex-rates","form-144-intel",
  "funding-rates","gas-estimate","gas-prices","generate-meme","geocode","github-org-intel",
  "github-repo-intel","global-equity-indices","global-news-intel","gov-votes","hedge-fund-holdings",
  "hf-model-search","hn-search","housing-brief","http-headers","image-detect","imf-country-outlook",
  "income-statements","insider-trades","intel-pack","intl-stock-price","ip-intel","ipo-calendar",
  "job-search","json-extract","kimchi-premium","korean-crypto-movers","korean-market-movers",
  "labor-brief","labor-market","lbo-model","legal-search","limitless-markets","macro-brief",
  ...
  "roast","rss-reader","sanctions-screening","sec-filing-intel","sec-insider-trades",
  ...
  "strategy-signal","timezone","token-top-holders","treasury-auction-calendar","treasury-yields",
  "twitter-intel","tx-explainer","tx-intel","unit-converter","us-stock-history","us-stock-price",
  "usgs-earthquake","vision-analyze","wallet-balance","wallet-credit-score","wallet-screener",
  "wayback-intel","weather","weather-alerts","weather-history","web-change-monitor",
  "web-company-intel","web-scrape-links","whale-radar","wikipedia-intel","world-bank-data",
