...
const ALL_CAPS = [
  ...
  "balance-sheet","cash-flow-statement","db-perf-intel","dcf-valuation","defi-market-pulse","defi-portfolio","defi-state-pack","defi-yield-strategies",
