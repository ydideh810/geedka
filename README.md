...
## Current capabilities — 197 live tools (v4.51.0)
...
| `dictionary-intel` | $0.001 | English word lookup: definitions (up to 4 per part of speech), IPA phonetics, audio pronunciation URL, synonyms, antonyms, and usage examples. Useful for writing agents, NLP preprocessing, and content generation. No API key. |
...
- [x] **196 capabilities LIVE** at `https://the-stall.intuitek.ai` (Base mainnet, v4.50.0)
